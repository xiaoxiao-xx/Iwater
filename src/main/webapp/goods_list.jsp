...
<div class="wrapper">
    ...
    <div class="page-content">
        <div class="content">
            ...
            <button class="layui-btn" onclick="member_add('添加商品','goods_add.jsp','600','500')"><i class="layui-icon">&#xe608;</i>添加</button><span class="x-right" style="line-height:40px" id="number_goods">....</span></xblock>
            <div id="list">
...
<script>
    ...
    function showpage(pn) {
        ...
        $.getJSON('goodsController/showlist.ajax',data,function (re){
            $("#ctable").html("");
            $.each(re,function (n,l) {
                $("#ctable").append("<tr><td>"+l.goodsName+"</td><td>"+l.goodsIn+"</td><td >"+l.goodsOut+"</td><td >"+l.goodsSpecs+"</td><td class=\"td-manage\"><a title=\"编辑\" href=\"javascript:;\" onclick=\"member_edit('编辑','goodsController/before_edit.do?id="+l.goodsId+"',4,'',510)\" class=\"ml-5\" style=\"text-decoration:none\"><i class=\"layui-icon\">&#xe642;</i></a><a title=\"删除\" href=\"javascript:;\" onclick=\"member_del(this,'"+l.goodsId+"')\" style=\"text-decoration:none\"><i class=\"layui-icon\">&#xe640;</i></a></td></tr>\n");
            })
    ...
    function member_del(obj,id){
        layer.confirm('确认要删除吗？',function(index){
            //发异步删除数据
            $.post('goodsController/deleteGood.ajax',{id:id},function(res){
                if(res=="yes"){
